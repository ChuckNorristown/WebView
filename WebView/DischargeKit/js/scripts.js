...
$(document).on('mousedown touchstart','.tab',function(){
    ...
    {
        case 0:
            for(var i = 0; i < Math.abs(currsec - 1); i++)
            {
                setTimeout(function(){
                    TurnLeft();
                },(i * 250));
                setTimeout(function(){
                    flipping = false;
                },Math.abs(currsec - 1) * 250);
            }
        break;
        case 1:
            if(currsec > 3)
            {
                for(var i = 0; i < Math.abs(currsec - 3); i++)
                {
                    setTimeout(function(){
                        TurnLeft();
                    },(i * 250));
        ...
        case 2:
            if(currsec > 4)
            {
                for(var i = 0; i < Math.abs(currsec - 4); i++)
                {
                    setTimeout(function(){
                        TurnLeft();
                    },(i * 250));
        ...
        case 3:
            if(currsec > 5)
            {
                for(var i = 0; i < Math.abs(currsec - 5); i++)
                {
                    setTimeout(function(){
                        TurnLeft();
                    },(i * 250));
        ...
        case 4:
            if(currsec > 8)
            {
                for(var i = 0; i < Math.abs(currsec - 8); i++)
                {
                    setTimeout(function(){
                        TurnLeft();
                    },(i * 250));
        ...
        case 5:
            if(currsec > 11)
            {
                for(var i = 0; i < Math.abs(currsec - 1); i++)
                {
                    ...
                    setTimeout(function(){
                        flipping = false;
                    },Math.abs(currsec - 11) * 250);
                }
            }
            else
            {
                for(var i = 0; i < Math.abs(currsec - 11); i++)
                {
                    setTimeout(function(){
                        TurnRight();
                    },(i * 250));
